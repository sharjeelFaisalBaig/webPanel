    ...
    <div class="swiper-container full-slider featured animation slider-h-100">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-center">
                <video type="video/mp4" class="full-image" data-mask="70" src="assets/videos/fireworks.mov" autoplay loop muted></video>
                <img data-aos="zoom-out-up" data-aos-delay="800" src="assets/images/fireworks.svg" class="hero-image" alt="Hero Image" style="max-width: 32rem;">
                <div class="slide-content row">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left bss">
                            <h1 data-aos="zoom-out-up" data-aos-delay="1000" class="title effect-static-text">CELEBRATING <br> SILVER JUBLEE.</h1>
                            <h3 data-aos="zoom-out-up" data-aos-delay="1500" class="description pl-md-1">We Thanks our Clients 100% Reviews. <br> On this event we offer you great discounts</h3>
                            <h3 data-aos="zoom-out-up" data-aos-delay="1500" class="closeFit"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></h3>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="contacts" class="section-1 offers bg-white">
    <div class="container">
        <div class="row intro">
        ...
        <div class="row justify-content-center text-center items">
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card bx-high featured">
            ...
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card bx-high">
                    <i class="icon icon-envelope"></i>
                    <h4>support@modSol.com</h4>
                    ...
                    <div class="row intro form-content">
                        <div class="col-12 p-0">
                            ...
                            <div class="step-title">
                                <h2 class="featured alt">Lets Talk!</h2>
                    ...
                    <div class="row text-center form-content">
                        <div class="col-12 p-0">
                            ...
                            <fieldset class="step-group">
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        ...
                                        <select name="projectType" data-minlength="1" class="form-control" required>
                                            ...
                                            <optgroup label="Advance Solutions">
                                                <option value="SaaS ERP (Cloud-Based)">SaaS ERP (Cloud-Based)</option>
                                                <option value="Advance ERP">Advance ERP</option>
                                                <option value="Electronic QR / BAR Code Attendance System">Electronic QR / BAR Code Attendance System</option>
                                                <option value="Embedded System (IOT)">Embedded System (IOT)</option>
                                            </optgroup>
                                            <optgroup label="Social Solutions">
                                ...
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="text" name="projectName" data-minlength="3" class="form-control" placeholder="Suggested Name Of Your Project" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                            ...
                            <fieldset class="step-group">
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <textarea name="message" data-minlength="3" class="form-control" placeholder="Short description of your project" required></textarea>
                                    </div>
                                </div>
