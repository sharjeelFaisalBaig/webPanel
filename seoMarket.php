...
<section id="slider" class="hero p-0 featured left bss">
    <div class="swiper-container no-slider animation slider-h-100 fix-height bss">
        <div class="swiper-wrapper">
            <!-- Item 1 -->
            <div class="swiper-slide slide-center">
                <div id="particles-1" class="particles full-image" data-aos-delay="1000" data-particle="bubble"></div>
                <img data-aos="zoom-out-up" data-aos-delay="800" src="assets/images/hero-11.png" class="hero-image" alt="Hero Image">
                <div class="slide-content row bg-light-transparent" data-mask-768="80">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">LEVEL UP YOUR REACH WITH MARKETING</h1>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description text-white-md">Promote your bussiness with <strong>MODREN MARKETING</strong><br>Modren Solutions for Modren Startups</p>
                            <div class="col-md-4 d-flex-md-align-center786 pl-md-0">
                                <a href="#services" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="text-danger fas fa-rocket mr-2"></i>BOOST NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row intro">
            <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                ...
                <p class="text-dark">Let everyone be aware about you</p>
            </div>
        ...
        <div class="row justify-content-center text-center items">
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card featured goForm">
                    <i class="icon icon-rocket"></i>
                    <h4>Kick Start From Scratch</h4>
                    <p>New! here just Click here to <strong>Kick Start</strong> your bussiness</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card featured goForm">
                    <i class="fab fa-chrome m-auto fa-3x color-theme"></i>
                    <h4>On-Page SEO</h4>
                    <p>It includes strategies to optimize an individual page on a website. Simply Multiply your traffic</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-tachometer-alt m-auto fa-3x color-theme"></i>
                    <h4>Off-Site SEO</h4>
                    <p>help strengthen the influence and relationship your website has with other websites.</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-mail-bulk m-auto fa-3x color-theme"></i>
                    <h4>Social Media Marketing</h4>
                    <p>Modrenize your bussiness with modren tools</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-phone-square-alt m-auto fa-3x color-theme"></i>
                    <h4>Tele Marketing</h4>
                    <p>Rock with <strong>TRADITIONAL</strong> marketing tool & pitch more clients</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fab fa-flipboard m-auto fa-3x color-theme"></i>
                    <h4>Advertisement</h4>
                    <p>Advertisements delivers more than expensive tools</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
        </div>
...
<div class="attachCover">
    <div class="col-1 h-attached toggleHide-2">Marketing Qoutation</div>
        ...
        <form class="getQouted">
            ...
            <div class="col-md-12 mt-2">
                <select name="qouteTask" class="form-control bg-white border-0 rounded-0" required>
                    <option value="Country" disabled="" selected="" class="select-country">Boost Type</option>
                    <optgroup label="SEO">
                    ...
                    <option value="Rankings Portal">Rankings Portal</option>
                </select>
            </div>
                ...
                <div class="row">
                    <div class="col-md-2 mb-3-md">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link tabVertical text-left active" data-toggle="pill" data-coverage="portfolioMain" data-target="seo" role="tab" aria-controls="v-pills-home" aria-selected="true">SEO</a>
                            <a class="nav-link tabVertical text-left" data-toggle="pill" data-coverage="portfolioMain" data-target="marketting" role="tab" aria-controls="v-pills-settings" aria-selected="false">Marketing</a>
                            <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor text-white  pl-3 pt-2">Others</a>
                        </div>
                    </div>
                    <div class="col-md-10 p-0 seo portfolioMain">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <h4>Essential</h4>
                                    <span class="price"><i>$</i>500.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>3 Month SEO Package</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>3 Months Subscription $1500</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>5 Keywords For 3 Months</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Image Alt Tag Optimization</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>On-Page Text Keywords Optimized</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>HTML Optimization</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Sitemap .Xml Creation</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Internal Links Optimization</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>06 Press Releases Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>45 Articles Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>*1st Month Fee Is For On-Page Optimization Only</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <i class="icon icon-handbag"></i>
                                    <h4>Team</h4>
                                    <span class="price"><i>$</i>850.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>6 Month SEO Package</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>6 Months Subscription $2700</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>5 Keywords For 6 Months</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>On-Page Optimization</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>12 Press Releases Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>90 Articles Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>30% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Corporate</h4>
                                    <span class="price"><i>$</i>400.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>12 Month SEO Package</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>12 Months Subscription $4800</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>5 Keywords For 12 Months</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>On-Page Optimization</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>18 Press Releases Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>135 Articles Writing/Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Social Bookmarking</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Profile Link Building</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Infographics Creation &amp; Marketing</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>90 Blog Posts Writing &amp; Submission</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Blogs &amp; Forums Commenting</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>*1st Month Fee Is For On-Page Optimization Only</span>
                    ...
                    <div class="col-md-10 p-0 marketting portfolioMain" style="display: none !important;">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <i class="icon icon-handbag"></i>
                                    <h4>Essential</h4>
                                    <span class="price"><i>$</i>249.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>5 Weekly Posting Any 4 Social Media Platforms</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Promotional Postings</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Offer Postings</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Animated Gif Postings</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Updated Cover Photo 1 Every Month</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>30sec Animated Videos 1 Each Month</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Dedicated Social Media Expert</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <i class="icon icon-handbag"></i>
                                    <h4>Corporate</h4>
                                    <span class="price"><i>$</i>1700.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>8 Weekly Posting Any 4 Social Media Platforms</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Promotional Postings</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Tips And Facts Postings</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
