...
<section id="slider" class="hero p-0 odd bss">
    <div class="swiper-container full-slider featured animation slider-h-100 fix-height bss">
        <div class="swiper-wrapper">
            <!-- Item 3 -->
            <div class="swiper-slide slide-center">
                <video type="video/mp4" class="full-image" data-mask="70" src="assets/videos/colors.mp4" autoplay loop muted></video>
                <img data-aos="zoom-out-up" data-aos-delay="800" src="assets/images/hero-6.svg" class="hero-image d-none-md" alt="Hero Image" style="top: 13px;">
                <div class="slide-content row bss" data-mask-768="50">
                    <div class="col-12 d-flex inner bss">
                        <div class="left align-self-center text-center text-md-left bss">
                            <h2 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">MODREN<br>WEB DESIGN.</h2>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description">Reach the next level, are you ready? Count on us to revolutionize your company's online identity.</p>
                            <div class="d-md-flex justify-content-md-start d-flex-md-align-center786">
                                <!-- <div class="col-md-4 d-flex-md-align-center786">
                                    <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button goContact"><i class="fas fa-comments mr-2"></i>DISCUSS</a>
                                </div> -->
                                <div class="col-md-4 d-flex-md-align-center786 pl-md-0">
                                    <a href="#portfolio-grid" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="fas text-danger fa-fire mr-2"></i>Portfolio</a>
                                </div>
                                <div class="col-md-4 d-flex-md-align-center786">
                                    <a href="#pricing" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="fas text-danger fa-dollar-sign mr-2"></i>Price Plans</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section id="portfolio-grid" class="section-1 showcase portfolio blog-grid filter-section bg-white pt-md-5 pb-md-5" style="background: aliceblue !important;">
    <div class="overflow-holder">
        <div class="container">
            <div class="col-md-12">
                <img src="assets/images/discount.png" class="d-none-md786 behind-portfolio" />
                <img src="assets/images/discountbgPattern.png" class="patternBehind-portfolio" />
            </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-12">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        ...
                        <label class="btn">
                            <input type="radio" value="ecommerece" class="btn-filter-item">
                            <span>E-COMMERCE</span>
                        </label>
                        <label class="btn">
                            <input type="radio" value="industrial" class="btn-filter-item">
                            <span>INDUSTRIAL</span>
                        </label>
                        <label class="btn">
                            <input type="radio" value="ecommereceSolutions" class="btn-filter-item">
                            <span>COMPLETE E-STORE SOLUTIONS</span>
                        </label>
                        <label class="btn">
                            <input type="radio" value="portfolio" class="btn-filter-item">
                            <span>PORTFOLIO WEBSITES</span>
                        </label>
                        <label class="btn">
                            <input type="radio" value="service" class="btn-filter-item">
                            <span>SERVICES</span>
                        </label>
                    </div>
                </div>
            ...
            <div class="row items filter-items">
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (8).png">
                                <img class="fitIt" src="assets/images/portfolio/web (8).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">ECOMMERCE SOLUTION KIT</h3>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (10).png">
                                <img class="fitIt" src="assets/images/portfolio/web (10).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (11).png">
                                <img class="fitIt" src="assets/images/portfolio/web (11).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (12).png">
                                <img class="fitIt" src="assets/images/portfolio/web (12).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (7).png">
                                <img class="fitIt" src="assets/images/portfolio/web (7).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (6).png">
                                <img class="fitIt" src="assets/images/portfolio/web (6).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (5).png">
                                <img class="fitIt" src="assets/images/portfolio/web (5).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (1).png">
                                <img class="fitIt" src="assets/images/portfolio/web (1).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery fitIt">
                            <a href="assets/images/portfolio/web (9).png">
                                <img class="fitIt" src="assets/images/portfolio/web (9).png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["industrial","service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/4.png">
                                <img class="fitIt" src="assets/images/portfolio/4.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">INDUSTIRAL WEBSITE & SERVICES WEBSITE</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/5.png">
                                <img class="fitIt" src="assets/images/portfolio/5.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">ECOMMERCE SOLUTION WEBSITE</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/6.png">
                                <img class="fitIt" src="assets/images/portfolio/6.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/7.png">
                                <img class="fitIt" src="assets/images/portfolio/7.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/8.png">
                                <img class="fitIt" src="assets/images/portfolio/8.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["ecommereceSolutions","ecommerece"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/9.png">
                                <img class="fitIt" src="assets/images/portfolio/9.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["industrial"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/1.png">
                                <img class="fitIt" src="assets/images/portfolio/1.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">INDUSTIRAL WEBSITE</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/2.png">
                                <img class="fitIt" src="assets/images/portfolio/2.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                    ...
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/3.png">
                                <img class="fitIt" src="assets/images/portfolio/3.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["industrial","service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/10.png">
                                <img class="fitIt" src="assets/images/portfolio/10.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">Parcel and Courier Delivery Service</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["industrial","service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/11.png">
                                <img class="fitIt" src="assets/images/portfolio/11.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">Hosting Services Provider</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/12.png">
                                <img class="fitIt" src="assets/images/portfolio/12.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">Hotel Management Services</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/13.png">
                                <img class="fitIt" src="assets/images/portfolio/13.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">Job Provider Services</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["industrial","service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/14.png">
                                <img class="fitIt" src="assets/images/portfolio/14.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
                                <h3 style="font-size: 27px;" class="m-0">Stock Trading</h3>
                            </div>
                            <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                <p></p>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["portfolio","service"]'>
                    <div class="row card p-0 text-center">
                        <div class="gallery">
                            <a href="assets/images/portfolio/22.png">
                                <img class="fitIt" src="assets/images/portfolio/22.png" alt="PORTFOLIO">
                            </a>
                        </div>
                        <div class="card-caption col-12 p-0 d-none">
                            <div class="card-body">
...
<div class="attachCover">
    <div class="col-1 h-attached toggleHide-2">Website Qoutation</div>
    <div class="col-11 pt-2 pb-2 p-4 attach-side hide-2">
        <form class="getQouted">
            <div class="col-md-12">
                <input name="qouteName" type="text" class="form-control bg-white border-0 rounded-0" required placeholder="Full Name">
            </div>
            <div class="col-md-12 mt-2">
                <select name="qouteCountry" class="form-control bg-white border-0 rounded-0">
                    <option value="Country" disabled="" selected="" class="select-country" required>Select Your Country</option>
            ...
            <div class="col-md-12 mt-2 d-flex">
                <select class="countryCode" name="countryCodeQouted" id="countryCodeQouted" required>
                ...
                <input name="qouteNumber" type="number" class="form-control bg-white border-0 rounded-0" required placeholder="Phone Number">
            </div>
            <div class="col-md-12 mt-2">
                <input name="qouteEmail" type="email" class="form-control bg-white border-0 rounded-0" required placeholder="Email Address">
            </div>
            <div class="col-md-12 mt-2">
                <select name="qouteTask" class="form-control bg-white border-0 rounded-0" required>
                    <option value="" selected disabled>Select Website Type ?</option>
                    <option value="Ecommerce Website">Ecommerce</option>
                    <option value="Event Management Website">Event Management Website</option>
                    <optgroup label="Industrial Website">
                        <option value="B2B Portals">B2B Portals</option>
                        <option value="Metalic Industry">Metalic Industry</option>
                        <option value="Bussiness Management ERP">Bussiness Management ERP</option>
                    </optgroup>
                    <optgroup label="Service Platforms">
                        <option value="Educational Website">Educational Website</option>
                        <option value="Clinical Website">Clinical Website</option>
                        <option value="Employee Hiring Platforms">Employee Hiring Platforms</option>
                    </optgroup>
                    <option value="Others">Others</option>
                </select>
            </div>
            <input name="accesstoken" value="quoted!55nn2@##@$#25efdsacdsaazx!!@@" type="hidden">
            <input name="accessType" value="qouted" type="hidden">
            <div class="col-md-12 mt-3 text-center d-flex justify-content-end">
                <button type="submit" class="btn dark-button">Place Order</button>
            </div>
        </form>
    </div>
</div>
<section id="skills" class="section-2 odd counter skills pt-5 pb-5">
    <div class="container">
        <div class="row text-center intro">
            <div class="col-12">
                <h2>SUCESSFULL WEBSITES RUNNING</h2>
                <p class="text-max-800">There are dozens of websites we made are running successfully</p>
            </div>
        </div>
        <div data-aos-id="counter" data-aos="fade-up" data-aos-delay="200" class="row justify-content-center text-center items">
            ...
            <div class="col-12 col-md-6 col-lg-4 item">
                <div data-percent="89" class="radial">
                    <span></span>
                </div>
...
<section id="pricing" class="section-1 plans">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-11 m-auto p-0-md">
                <div class="col-md-12">
                    <img src="assets/images/discount.png" class="d-none-md786 behind-discount" />
                    <img src="assets/images/discountbgPattern.png" class="patternBehind-discount" />
                </div>
                <div class="row intro">
                    <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                        <h2 class="featured text-white">Pricing Plan</h2>
                        <p class="text-white">We make Great but Affordable</p>
                    </div>
                ...
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item">
                        <div class="card ov-hidden-all">
                            <div class="discountPrice"><b>50% OFF !</b></div>
                            <i class="icon icon-handbag"></i>
                            <h4>Essential E-Commerce</h4>
                            <span class="price"><i>$</i>799.00</span>
                            <ul class="list-group list-group-flush max-stop">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Mini Shopping Cart Integration</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>

                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Payment Module Integration</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>

                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Easy Product Search</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>

                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Dedicated designer &amp; developer</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>100% Unique Design Guarantee</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                        <div class="card ov-hidden-all">
                            <div class="discountPrice"><b>70% OFF !</b></div>
                            <i class="icon icon-diamond"></i>
                            <h4>Team E-Commerce</h4>
                            <span class="price"><i>$</i>1115.00</span>
                            <ul class="list-group list-group-flush max-stop">
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Customized Design</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Full Shopping Cart Integration</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Payment Module Integration</span>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Team of Expert Designers &amp; Developers</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Unlimited Revisions</span>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                        <div class="card ov-hidden-all">
                            <div class="discountPrice"><b>60% OFF !</b></div>
                            <i class="icon icon-fire"></i>
                            <h4>Corporate E-Commerce</h4>
                            <span class="price"><i>$</i>4800.00</span>
                            <ul class="list-group list-group-flush max-stop">
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    <span>Complete Custom Design &amp; Development</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Unique, User Friendly, Interactive, Dynamic, High End UI Design</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Unlimited Banner Designs</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Interactive Sliding Banners</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>Customized Contact us Form</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Multiple Filtration Option (Search by Age, Experience, Talent, Industry etc)</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Profile Comparison (As per Category)</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>Custom Video Functionality</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Multiple File format Uploading</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>User Signup Area ( Talent )</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>User Signup Area ( Casting )</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>User Signup Area ( Agency )</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Client/User Dashboard Area</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Vendor / Agency Dashboard Area</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Custom Coding and Development</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Content Management System (Custom)</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Online Appointment/Scheduling integration (Optional)</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>Custom Dynamic Forms</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Complete Database Creation</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>3rd Party Links integration (Instagram, IMDB etc )</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Signup Automated Email Authentication</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>Search Bar for Easy Search</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>SSL Certification (to make the website and it`s informative secured)</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>6 Months of Free Maintenance</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Award Winning Team of Expert Designers and Developers</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <span>Complete W3C Validation</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                    <span>Dedicated Team of Designers and Developers</span>
                                    <i class="icon-min m-0 icon-check text-right"></i>
                                </li>
                            </ul>
                            <a href="#contact" class="smooth-anchor btn mx-auto primary-button"><i class="icon-arrow-right-circle"></i>CHOSE PLAN</a>
                ...
                <div class="col-md-10 p-0 portfolio portfolioMain" style="display: none !important;">
                    <div class="row justify-content-center text-center items">
                        <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                            <div class="card ov-hidden-all">
                                <div class="discountPrice"><b>50% OFF !</b></div>
                                <i class="icon icon-handbag"></i>
                                <h4>Business</h4>
                                <span class="price"><i>$</i>1299.00</span>
                                <ul class="list-group list-group-flush max-stop">
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        <span>Upto 14-16 Unique Pages Website</span>
                                        <i class="icon-min m-0 icon-check text-right"></i>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        <span>Lead Capturing Forms</span>
                                        <i class="icon-min m-0 icon-check text-right"></i>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                            <div class="card ov-hidden-all">
                                ...
                                <i class="icon icon-handbag"></i>
                                <h4>Enterprise</h4>
                                <span class="price"><i>$</i>1999.00</span>
                                <ul class="list-group list-group-flush max-stop">
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <span>Up to 8 Custom Made Banner Designs</span>
                                        <i class="icon-min m-0 icon-check text-right"></i>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                        <span>12 Stock Images</span>
                                        <i class="icon-min m-0 icon-check text-right"></i>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <span>Content Management System (CMS) or Custom Dashboard PHP</span>
                                        <i class="icon-min m-0 icon-check text-right"></i>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                ...
                <div class="col-md-10 p-0 industrial portfolioMain" style="display: none !important;">
                    <div class="row justify-content-center text-center items">
                        <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                            <div class="card">
                                <i class="icon icon-handbag"></i>
                ...
                <div class="col-md-10 p-0 serviceWeb portfolioMain" style="display: none !important;">
                    <div class="row justify-content-center text-center items">
                        <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                            <div class="card">
                                <i class="icon icon-handbag"></i>
...
<section id="about" class="section-1 odd highlights image-right" style="background: #000000;">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 align-self-center text-center text-md-left">
                <div class="row intro">
                    <div class="col-12 p-0">
                        <h2 class="featured alt">Key Fetures</h2>
                        <p>For over many years we have been developing digital solutions for companies looking to gain better visibility on the internet.</p>
                    </div>
                </div>
                <div class="row items">
                    <div class="col-12 p-0">
                        ...
                        <div class="row item">
                            <div class="col-12 col-md-2 align-self-center">
                                <i class="icon fas fa-fire" style="color: #fb0430;"></i>
                            </div>
                            <div class="col-12 col-md-9 align-self-center">
                                <h4>Modren Designs</h4>
                                <p>We are know for designs that feels good and looks good</p>
                            </div>
                        </div>
                        <div class="row item">
                            <div class="col-12 col-md-2 align-self-center">
                                <i class="icon fas fa-tools" style="color: #fb0430;"></i>
                            </div>
                            <div class="col-12 col-md-9 align-self-center">
                                <h4>Maintainance Service</h4>
                                <p>We offer site maintainance 1st time free</p>
                            </div>
                        </div>
                        <div class="row item">
                            <div class="col-12 col-md-2 align-self-center">
                                <i class="icon fas fa-tachometer-alt" style="color: #fb0430;"></i>
                            </div>
                            <div class="col-12 col-md-9 align-self-center">
                                <h4>FAST | On Time</h4>
                                <p>We offer Fast and On time service that delivers <strong>Quality</strong> as well</p>
                            </div>
                        </div>
                        <div class="row item">
                            <div class="col-12 col-md-2 align-self-center">
                                <i class="icon icon-screen-smartphone" style="color: #fb0430;"></i>
                            </div>
                            <div class="col-12 col-md-9 align-self-center">
                                <h4>Perfect responsive</h4>
                                <p>No need to worry whe with us</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6">
                <img src="assets/images/website/keyFeatures.jpg" class="fit-image" alt="About Us" style="max-height: 61rem;">
            </div>
        </div>
    </div>
</section>
<section id="contact" class="section-7 odd form featured all bss">
    <div class="container">
        <form class="multi-step-form detailDisscus">
            <div class="row">
                <div class="col-12 col-md-7 align-self-start text-center text-md-left">
                    ...
                    <div class="row intro form-content">
                        <div class="col-12 p-0">
                            ...
                            <div class="step-title">
                                <h2 class="featured alt">☕ Discuss Project</h2>
                                <p>Don't wait until tomorrow. Take a cup of coffee & get started.</p>
                            </div>

                            <!-- Step Title -->
                            <div class="step-title">
                                <h2 class="featured alt">Project Details?</h2>
                            ...
                            <div class="step-title">
                                ...
                                <p>Tell us a little about the project you need to create. This is valuable so that
                                    we can direct you to the ideal team.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center form-content">
                        <div class="col-12 p-0">
                            ...
                            <fieldset class="step-group">
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="email" name="email" data-minlength="3" class="form-control" required placeholder="Email">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="text" name="name" data-minlength="3" class="form-control" required placeholder="Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <select name="country" data-minlength="1" class="form-control">
                                            <option value="Country" disabled="" selected="" class="select-country" required>Select Your Country</option>
                                            <option value="Afghanistan">Afghanistan</option>
                                            <option value="Albania">Albania</option>
                                            <option value="Algeria">Algeria</option>
                                ...
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <select class="countryCode text-white bg-transparent" name="countryCode" id="countryCode" style="border: solid .7px rgb(255 255 255 / 25%);" required>
                                            <option data-countrycode="Norway (+47)" value='+47' selected>+47</option>
                                            <option data-countrycode="UK (+44)" value='+44'>UK (+44)</option>
                                            <option data-countrycode="Algeria (+213)" value='+213'>Algeria (+213)</option>
                                            <option data-countrycode="Andorra (+376)" value='+376'>Andorra (+376)</option>
                                        ...
                                        <input type="text" name="phone" data-minlength="3" class="form-control" required placeholder="Phone">
                                    </div>
                                </div>
                                <div class="col-12 input-group p-0">
                            ...
                            <fieldset class="step-group">
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        ...
                                        <select name="projectType" data-minlength="1" class="form-control" required>
                                            <option value="" selected disabled>Select Website Type ?</option>
                                            <option value="Ecommerce Website">Ecommerce</option>
                                            <option value="Event Management Website">Event Management Website</option>
                                            <optgroup label="Industrial Website">
                                ...
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="text" name="projectName" data-minlength="3" class="form-control" placeholder="Suggested Name Of Your Website" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <i class="icon-arrow-down"></i>
                                        <select name="budget" data-minlength="1" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="text" name="company" data-minlength="3" class="form-control" placeholder="Company">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <input type="text" name="companyLocation" data-minlength="3" class="form-control" placeholder="Company Location">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <i class="icon-arrow-down"></i>
                                        <select name="companyType" data-minlength="1" class="form-control">
                            ...
                            <fieldset class="step-group">
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        <textarea name="message" data-minlength="3" class="form-control" placeholder="Short description of your Website" required></textarea>
                                    </div>
                                </div>
                                <input name="accesstoken" value="quoted!55nn2@##@$#25efdsacdsaazx!!@@" type="hidden">
                                <input name="accessType" value="detailed" type="hidden">
                                <input name="discountType" class="discountType" value="0" type="hidden">
                                <div class="col-12 input-group p-0 d-flex justify-content-between justify-content-md-start">
                                    <a class="step-prev btn primary-button mr-4"><i class="icon-arrow-left-circle"></i>PREV</a>
                                    <button type="submit" class="btn primary-button">SEND<i class="icon-arrow-right-circle left"></i></button>
                                </div>
                            </fieldset>
                ...
                <div class="content-images col-12 col-md-5 pl-md-5 d-none d-md-block">
