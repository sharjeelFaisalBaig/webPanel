...
<section id="slider" class="hero p-0 featured left bss">
    <div class="swiper-container no-slider animation slider-h-100 bss fix-height">
        <div class="swiper-wrapper">
            <!-- Item 1 -->
            <div class="swiper-slide slide-center">
                <video type="video/mp4" class="full-image" data-mask="80" src="assets/videos/ink.mp4" autoplay muted loop style="transform: rotate(180deg);"></video>
                <img data-aos="zoom-out-up" data-aos-delay="800" src="assets/images/alone.svg" class="hero-image mx-41rem" alt="Hero Image">
                <div class="slide-content row" data-mask-768="80">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">BEST WRITING SERVICE</h1>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description text-white">Best Quality Content Writing Service offered by Modren Soultions</p>
                            <div class="col-md-4 d-flex-md-align-center786 pl-md-0">
                                <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 openOrder btn dark-button"><i class="text-danger fas fa-hand-holding-usd mr-2"></i> PLACE ORDER</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row intro">
            <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                ...
                <p class="text-dark">Best Content Writing service in entire <strong><i>USA</i></strong></p>
            </div>
        ...
        <div class="row justify-content-center text-center items">
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm featured">
                    <i class="fas fa-paragraph m-auto fa-3x color-theme"></i>
                    <h4>SEO Content Writing</h4>
                    <p>Order Keyword-Rich Content to Drive Search Traffic. Simply Multiply your traffic</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fab fa-blogger-b m-auto fa-3x color-theme"></i>
                    <h4>Blog Post Writing</h4>
                    <p>Order Content For Your Blog That Will Drive Traffic and Delight Readers</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-pen-alt m-auto fa-3x color-theme"></i>
                    <h4>Academic Writing</h4>
                    <p>Can't Manage time not need to confused just drop your Assignment & go stressfree</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-stream m-auto fa-3x color-theme"></i>
                    <h4>Thesis Writing</h4>
                    <p>We provide complete thesis help from the topic suggestion to the final delivery.</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-book m-auto fa-3x color-theme"></i>
                    <h4>Coursework Writing</h4>
                    <p>Just think about how many times have you felt helpless because of assignments?</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm featured">
                    <i class="fas fa-newspaper m-auto fa-3x color-theme"></i>
                    <h4>Articles Wiriting</h4>
                    <p>we fill in the writing gap to help you scale without constantly to find new articles</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
        </div>
...
<section id="get-2" class="section-2 hero p-0 odd featured right bss">
    <div class="swiper-container no-slider animation slider-h-100">
        <div class="swiper-wrapper">
            <div class="swiper-slide slide-center">
                <img src="assets/images/featured-4.svg" class="hero-image-left" alt="Hero Image" style="padding-bottom: 24px;">
                <div class="slide-content row bg-light-transparent" data-mask-768="70">
                    <!--style="max-width: 38.5rem;width: 38.5rem;object-fit: contain;padding-bottom: 20px;"-->
                    <div class="col-12 d-flex justify-content-end inner">
                        <div class="right text-center text-md-right">
                            <h2 class="title effect-static-text">BEST SEO <br> SERVICES <br> IN USA</h2>
                            <p class="description ml-auto text-white-md">Renowned as a top SEO services in USA, <br> Let your <strong><i>TRAFFIC <i class="text-danger icon-fire"></i></i></strong> blast.</p>
                            <div class="col-md-12 d-flex-md-align-center786 pl-md-0 justify-content-end-md d-md-flex">
                                <a href="seo" class="btn dark-button"><i class="fab fa-chrome text-danger mr-1"></i>SEO SERVICES</a>
                            </div>
                            <div class="col-md-12 d-flex-md-align-center786 mt-3 pl-md-0 justify-content-end-md d-md-flex">
                                <a href="#contact" class="smooth-anchor openOrder btn dark-button"><i class="fa fa-pen-alt text-danger mr-1"></i>SEO WRITING SERVICE</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="attachCover">
    <div class="col-1 h-attached toggleHide-2">Writing Qoutation</div>
        ...
        <form class="getQouted">
            ...
            <div class="col-md-12 mt-2">
                <select name="qouteTask" class="form-control bg-white border-0 rounded-0" required>
                    <option value="Country" disabled="" selected="" class="select-country">Writing Type</option>
                    <option value="seoW">SEO Content Writing</option>
                    <option value="blogW">Blog Post Writing</option>
                    <option value="socialMediaMarketing">Social Media Marketing</option>
                    <option value="teleMarketing">Tele Marketing</option>
                    <option value="advertisements">Advertisements</option>
                    <option value="ranks">Rankings Portal</option>
...
<div class="container-fluid bg-white ov-hidden">
    <div class="row">
        <div class="col-md-12 d-none-md786">
            <img src="assets/images/discount.png" class="behind" />
            <img src="assets/images/discountbgPattern.png" class="patternBehind" />
        </div>
        <div class="col-md-10 m-auto">
            <div class="row">
                <div class="col-md-4">
                    <h3 class="d-banner">Get Mega Discount</h3>
                    <button class="btn btn-dis btn-danger mt-3 rounded-2">Get Discounts</button>
                </div>
                <div class="col-md-6 offset-md-2 bg-discount">
                    <img src="assets/images/discount-bg-layer.png" />
                ...
                <div class="row">
                    <div class="col-md-2 mb-3-md">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link tabVertical text-left active" data-toggle="pill" data-coverage="portfolioMain" data-target="brandings" role="tab" aria-controls="v-pills-home" aria-selected="true">Starter Plans</a>
                            <a class="nav-link tabVertical text-left" data-toggle="pill" data-coverage="portfolioMain" data-target="extra" role="tab" aria-controls="v-pills-settings" aria-selected="false">Extra-Ordinary <br>Plans</a>
                        </div>
                    </div>
                    <div class="col-md-10 p-0 mt-2 brandings portfolioMain">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-2">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>40% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Essential</h4>
                                    <span class="price"><i>$</i>16.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>300 words per post</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Superior Quality Content</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>24/7*365 Customer Support</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                    </ul>
                                    <a href="#contact" class="smooth-anchor btn mx-auto primary-button mt-3"><i class="icon-arrow-right-circle"></i>CHOSE PLAN</a>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-2">
                                <div class="card ov-hidden-all">
                                    ...
                                    <h4>Team</h4>
                                    <span class="price"><i>$</i>29.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>600 words per post</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>By Award Winning Logo Designers</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-2">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>25% OFF !</b></div>
                                    <i class="icon icon-diamond"></i>
                                    <h4>Corporate</h4>
                                    <span class="price"><i>$</i>59.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>900 words per post</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                            ...
                            <div class="col-md-10 p-0 mt-2 portfolio portfolioMain" style="display: none !important;">
                                <div class="row justify-content-center text-center items">
                    ...
                    <div class="col-md-10 p-0 mt-2 extra portfolioMain" style="display: none;">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-2">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>40% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Essential</h4>
                                    <span class="price"><i>$</i>49.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>200 words per post</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Timely Delivery</span>
                            ...
                            <div class="col-md-10 p-0 mt-2 industrial portfolioMain" style="display: none !important;">
                                <div class="row justify-content-center text-center items">
                                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item">
                                        <div class="card">
                                            <i class="icon icon-handbag"></i>
                            ...
                            <div class="col-md-10 p-0 mt-2 serviceWeb portfolioMain" style="display: none !important;">
                                <div class="row justify-content-center text-center items">
                                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item">
                                        <div class="card">
                                            <i class="icon icon-handbag"></i>
...
FROM wpon_term_relationships AS relations
INNER JOIN wpon_term_taxonomy AS taxes
ON relations.term_taxonomy_id=taxes.term_taxonomy_id
INNER JOIN wpon_terms AS terms
ON taxes.term_id=terms.term_id
WHERE object_id IN (SELECT ID FROM wpon_posts WHERE post_type='product');
 
DELETE FROM wpon_postmeta WHERE post_id IN (SELECT ID FROM wpon_posts WHERE post_type = 'product');
DELETE FROM wpon_posts WHERE post_type = 'product';
