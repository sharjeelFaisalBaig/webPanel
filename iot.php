    ...
    <div class="swiper-container no-slider animation slider-h-100 fix-height bss">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-center">
                <div id="particles-1" class="particles full-image" data-particle="space" data-mask="1"></div>
                <img data-aos="zoom-out-up" data-aos-delay="800" src="assets/images/about-14-right.png" class="hero-image mx-41rem" alt="Hero Image">
                <div class="slide-content row" data-mask-768="80">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">WELCOME TO MODREN <br>CENTURY</h1>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description text-white-md">Meet IOT (Internet Of Things) the modren faimly suits <strong>MODREN SOLUTIONS</strong> Let everything be simplified</p>
                            <div class="col-md-4 d-flex-md-align-center786 pl-md-0">
                                <a href="#services" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="text-danger fas fa-rocket mr-2"></i>GET STARTED</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row intro">
            <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                ...
                <p class="text-dark">Let everything be simplified until it reach your <strong><i>SINGLE TOUCH</i></strong></p>
            </div>
            <div class="col-12 col-md-3 align-self-end">
                <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor btn mx-auto mr-md-0 ml-md-auto primary-button"><i class="icon-arrow-right-circle"></i> DISCUSS PROJECT</a>
            </div>
        </div>
        <div class="row justify-content-center text-center items">
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm featured">
                    <i class="fas fa-link m-auto fa-3x color-theme"></i>
                    <h4>Control Panel</h4>
                    <p>Control Everything by Single platform. Let everything be simplified</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-dice-d6 m-auto fa-3x color-theme"></i>
                    <h4>Warehouse Solutions</h4>
                    <p>Powerfull platform that tacle everything for you. Let linked <strong>ERP</strong> tacle everything</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fab fa-accusoft m-auto fa-3x color-theme"></i>
                    <h4>Breath Secure</h4>
                    <p>Let everything be secured, & controllable. By just <strong>ONE <i>CLICK</i></strong> All in one platform</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-qrcode m-auto fa-3x color-theme"></i>
                    <h4>QR Attendence System</h4>
                    <p>Having obstacles in maintaining records. Let it be done by <br> <strong>QR/BAR CODE</strong> Attendence System</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-charging-station m-auto fa-3x color-theme"></i>
                    <h4>Custom Embedded Systems</h4>
                    <p>Need advance solution that fulfil your requirements</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm featured">
                    <i class="fas fa-shopping-cart m-auto fa-3x color-theme"></i>
                    <h4>Remote Business Maintainance</h4>
                    <p>Let Your bussiness Stands Up without you</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
        </div>
...
<div class="attachCover">
    <div class="col-1 h-attached toggleHide-2">Project Qoutation</div>
        ...
        <form class="getQouted">
            ...
            <div class="col-md-12 mt-2">
                <select name="qouteTask" class="form-control bg-white border-0 rounded-0" required>
                    <option value="Country" disabled="" selected="" class="select-country">Project type</option>
                    <option value="Control Panel">Control Panel</option>
                    <option value="Warehouse Management">Warehouse Management</option>
                    <option value="Attendance System">Attendance System</option>
                    <option value="Custom Embedded System">Custom Embedded System</option>
                    <option value="Remote Bussiness Management">Remote Bussiness Management</option>
                                ...
                                <div class="row">
                                    <div class="col-12 input-group p-0">
                                        ...
                                        <select name="projectType" data-minlength="1" class="form-control" required>
                                            ...
                                            <option value="Warehouse Management">Warehouse Management</option>
                                            <option value="Attendance System">Attendance System</option>
                                            <option value="customEmbedd">Custom Embedded System</option>
                                            <option value="remoteBussinessManagement">Remote Bussiness Management</option>
                                            <option value="Others">Others</option>
                                        </select>
                                    </div>
                                </div>
