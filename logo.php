    ...
    <div class="swiper-container full-slider featured animation slider-h-100 fix-height bss">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-center">
                <img data-aos="zoom-out-up" data-aos-delay="800" data-mask-768="60" src="assets/images/hero-5.jpg" class="hero-image" alt="Hero Image">
                <div class="slide-content row bg-light-transparent" data-mask-768="50">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h2 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">IDENTITY DEPENDS<br>THE BRANDING.</h2>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description text-white-md">Don't let identity spoilt. Get completed with <strong><i>BRANDINGS</i></strong><br>Choose one to go with</p>
                            <div class="d-md-flex justify-content-md-start d-flex-md-align-center786">
                                ...
                                <div class="col-md-4 pl-md-0 d-flex-md-align-center786">
                                    <a href="#services" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="text-danger fas fa-rocket mr-2"></i>KICK START</a>
                                </div>
                                <div class="col-md-4 d-flex-md-align-center786">
                                    <a href="#pricing" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor mt-4 btn dark-button"><i class="text-danger fas fa-hand-holding-usd mr-2"></i>PRICING</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section id="services" class="section-1 offers bg-offWhite">
    <div class="container">
        <div class="col-md-12">
            <img src="assets/images/discount.png" class="d-none-md786 behind-portfolio" style="max-width: 62rem !important;top: 34rem;" />
            <img src="assets/images/discountbgPattern.png" class="patternBehind-portfolio" style="left: -5rem;top: -4rem;" />
        </div>
        <div class="row intro">
            <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                <h2 class="featured text-black">WE OFFERS</h2>
                <p class="text-dark">Focused on results we seek to raise the level of our customers.</p>
            </div>
            <div class="col-12 col-md-3 align-self-end">
                <a href="#pricing" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor btn mx-auto mr-md-0 ml-md-auto primary-button"><i class="icon-arrow-right-circle"></i> PRICING PLANS</a>
            </div>
        </div>
        <div class="row justify-content-center text-center items">
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm featured">
                    <i class="icon icon-rocket"></i>
                    <h4>Kick Start From Scratch</h4>
                    <p>New! Don't get confused or scamed Just Click here to <strong>Kick Start</strong> your bussiness</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fab fa-atlassian m-auto fa-3x color-theme"></i>
                    <h4>Logo Designs</h4>
                    <p>Let your logo represents your company, Let it be designed by <strong>PROFESSIONALS</strong> </p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fas fa-video m-auto fa-3x color-theme"></i>
                    <h4>Branding Videos</h4>
                    <p>Make your bussiness more clear with <strong>Branding Videos / Video messeges</strong></p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="far fa-id-card m-auto fa-3x color-theme"></i>
                    <h4>Visiting Cards</h4>
                    <p>Gain focus and change level of attention by a beautifull visiting card Let it manifest you</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
                <div class="card goForm">
                    <i class="fab fa-unity m-auto fa-3x color-theme"></i>
                    <h4>3D Videos / Printing</h4>
                    <p>Be modren with <strong>3 Dimensional</strong> Assets Videos, Structures that inspires</p>
                    <a href="#"><i class="btn-icon icon-arrow-right-circle"></i></a>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 item">
...
<div class="attachCover">
    <div class="col-1 h-attached toggleHide-2">Logo Qoutation</div>
        ...
        <form class="getQouted">
            ...
            <div class="col-md-12 mt-2">
                <select name="qouteTask" class="form-control bg-white border-0 rounded-0" required>
                    <option value="Country" disabled="" selected="" class="select-country">Brandings Type</option>
                    <option value="logo">Logo</option>
                    <option value="Branding Video">Branding Video</option>
                    <option value="Visiting Card">Visiting Card</option>
                    <option value="3D Printing / 3D Videos">3D Printing / 3D Videos</option>
...
<section id="pricing" class="section-1 bg-dark">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-11 m-auto p-0-md">
                ...
                <div class="row">
                    <div class="col-md-2 mb-3-md">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link tabVertical text-left active" data-toggle="pill" data-coverage="portfolioMain" data-target="logoDesign" role="tab" aria-controls="v-pills-messages" aria-selected="false">Logo Design</a>
                            <a class="nav-link tabVertical text-left" data-toggle="pill" data-coverage="portfolioMain" data-target="threeD" role="tab" aria-controls="v-pills-settings" aria-selected="false">3D / 2D Designs</a>
                            <a class="nav-link tabVertical text-left" data-toggle="pill" data-coverage="portfolioMain" data-target="anim" role="tab" aria-controls="v-pills-settings" aria-selected="false">Animations</a>
                            <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor text-white  pl-3 pt-2">Others</a>
                        </div>
                    </div>
                    <div class="col-md-10 p-0 logoDesign portfolioMain">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <h4>Essential</h4>
                                    <span class="price"><i>$</i>11.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>4 Revisions (Additional $20)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>By 2 Top Rated Dedicated Designers</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>24 - 48 Hours Turnaround Time</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Final Files (Jpeg, PNG)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>100% Assurance Guarantee</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>24/7 After Sales Support (Email, Chat, Call, SMS, WhatsApp)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                    </ul>
                                    <a href="#contact" class="smooth-anchor mt-4 btn mx-auto primary-button"><i class="icon-arrow-right-circle"></i>CHOOSE PLAN</a>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>20% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Enterprise</h4>
                                    <span class="price"><i>$</i>219.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>UNLIMITED Logo Concepts</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>By 2 Dedicated Team of Designers</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Social Media Design (Facebook, LinkedIn, Twitter)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>2 No's Flyer or 1 Bi-Fold Brochures</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Stationery Design (Business Cards, Letterhead, Invoice, envelope)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>10 Sec 2D Animated Logo Intro</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Legalization will be additional $499</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Grey Scale Format</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Final Files (Ai, PSD, PDF, SVG, EPS, Jpeg, PNG, Tiff)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Dedicated Account Manager</span>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>40% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Elite</h4>
                                    <span class="price"><i>$</i>429.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>UNLIMITED Logo Concepts</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>1 Custom Landing Page Website</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>By 1 Dedicated Developer</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Social Media Design (Facebook, LinkedIn, Twitter)</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Stationery Design (Business Cards, Letterhead, Invoice)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Email Signature</span>
                    ...
                    <div class="col-md-10 p-0 anim portfolioMain" style="display: none !important;">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>50% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Essential Animation</h4>
                                    <span class="price"><i>$</i>275.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>4 Custom 5 Sec Animated Logo Concepts</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>5 Revisions (Additional $20)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>By 4 Dedicated Design Animators</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Visual Effects &amp; Sound Effects</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>48 - 72 Hours Turn Around Time</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <span>Final Files (Mp4, MOV, Ai, PSD, PDF, SVG, EPS, Jpeg, PNG, Tiff)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>45% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Corporate Animation</h4>
                                    <span class="price"><i>$</i>475.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                            <span>6 Custom 5 Sec Animated Logo Concepts</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                            <span>10 Sec Teaser / Intro Animation</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            ...
                                            <span>By 6 Top Rated Dedicated Design Animators</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            ...
                                            <span>Social Media Intro (Facebook, LinkedIn, Twitter)</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                    ...
                    <div class="col-md-10 p-0 threeD portfolioMain" style="display: none !important;">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    <div class="discountPrice"><b>34% OFF !</b></div>
                                    <i class="icon icon-handbag"></i>
                                    <h4>Essential 3D</h4>
                                    <span class="price"><i>$</i>149.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">

                                            <span>1 Custom 3D Logo Concepts</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            ...
                                            <span>By 3 Top Rated Dedicated Designers</span>
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card ov-hidden-all">
                                    ...
                                    <i class="icon icon-handbag"></i>
                                    <h4>Team 3D</h4>
                                    <span class="price"><i>$</i>349.00</span>
                                    <ul class="list-group list-group-flush max-stop">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                            <span>2 Custom 3D Logo Concepts</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                            <span>5 Revisions (Additional $20)</span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                            <span>By 6 Top Rated Dedicated Designers</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-left">
                                            <i class="icon-min m-0 icon-check text-right"></i>
                                            <span>Social Media Design (Facebook, LinkedIn, Twitter)</span>
                    ...
                    <div class="col-md-10 p-0 visitingCard portfolioMain" style="display: none !important;">
                        <div class="row justify-content-center text-center items">
                            <div class="col-12 col-md-6 col-lg-4 align-self-center text-center item mt-4-md">
                                <div class="card">
                                    <i class="icon icon-handbag"></i>
